...
namespace Template.Infrastructure.Database.Migrations
{
    ...
    [Migration("20250817065249_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Template.Common.SharedKernel.Infrastructure.Outbox.OutboxMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Template.Domain.Entities.ApiKeys.ApiKey", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Template.Domain.Entities.Users.EmailVerificationToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Template.Domain.Entities.Users.Permission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Template.Domain.Entities.Users.RefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Template.Domain.Entities.Users.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Template.Domain.Entities.Users.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("PermissionRole", b =>
                {
                    b.HasOne("Template.Domain.Entities.Users.Permission", null)
                        .WithMany()
                    ...
                    b.HasOne("Template.Domain.Entities.Users.Role", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Template.Domain.Entities.Users.EmailVerificationToken", b =>
                {
                    b.HasOne("Template.Domain.Entities.Users.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Template.Domain.Entities.Users.User", b =>
                {
                    b.HasOne("Template.Domain.Entities.Users.Role", "Role")
                        .WithMany("Users")
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
