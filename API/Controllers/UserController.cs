...
[ApiController]
[Route("api/users")]
public class UserController(ISender sender, IUserContext userContext, IProducerAccessor producerAccessor) : ControllerBase
{
    [HttpPost("BRUV")]
    public async Task<IActionResult> POST()
    {
        IMessageProducer producer = producerAccessor.GetProducer("producer-test")!;

        await producer.ProduceAsync(
            "key",
            new HelloMessage { Id = 69 }
        );
